package `in`.cclub.android.currencyConvertor.view

import `in`.cclub.android.R
import `in`.cclub.android.currencyConvertor.helper.EndPoints
import `in`.cclub.android.currencyConvertor.helper.Resource
import `in`.cclub.android.currencyConvertor.helper.Utility
import `in`.cclub.android.currencyConvertor.model.Rates
import `in`.cclub.android.currencyConvertor.viewmodel.MainViewModel
import `in`.cclub.android.databinding.ActivityMoneyBinding
...
class Money : AppCompatActivity() {
    ...
    private var _binding: ActivityMoneyBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityMoneyBinding.inflate(layoutInflater)
