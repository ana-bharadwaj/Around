package `in`.cclub.currencyconvertor.view

import `in`.cclub.currencyconvertor.R
import `in`.cclub.currencyconvertor.databinding.ActivityMainBinding
import `in`.cclub.currencyconvertor.helper.EndPoints
import `in`.cclub.currencyconvertor.helper.Resource
import `in`.cclub.currencyconvertor.helper.Utility
import `in`.cclub.currencyconvertor.model.Rates
import `in`.cclub.currencyconvertor.viewmodel.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpClickListener() {
        ...
        binding.btnConvertCurrencyPage.setOnClickListener {
    ...
    private fun doConversion() {
        ...
        binding.btnConvertCurrencyPage.visibility = View.GONE
            ...
            when (result.status) {
                Resource.Status.SUCCESS -> {
                    if (result.data?.status == "success") {
                        ...
                        //show button
                        binding.btnConvertCurrencyPage.visibility = View.VISIBLE
